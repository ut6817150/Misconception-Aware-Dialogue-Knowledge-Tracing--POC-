"""
Taken from pykt (not available in pip): https://github.com/pykt-team/pykt-toolkit/blob/main/pykt/models/simplekt.py
"""
...
import numpy as np
from pykt.models.utils import transformer_FFN, ut_mask, pos_encode, get_clones
