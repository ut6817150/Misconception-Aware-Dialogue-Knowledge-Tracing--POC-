...
condensed annotation codebook below exactly. Judge every unit against the
mathematics of the stated problem, which you derive yourself first; never
trust a released answer. Judge each unit only from the problem, the student's
incorrect solution, and the turns up to and including it (forward-only), even
though the whole dialogue is visible to you.
